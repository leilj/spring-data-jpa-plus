...
public class Equal extends AbstractStatement implements Statement {

	public Equal(Root<?> root, CriteriaBuilder criteriaBuilder, String fieldName, String[] values) {
